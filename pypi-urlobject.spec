...
Source0  : https://files.pythonhosted.org/packages/2a/fd/163e6b835b9fabf9c3999f71c5f224daa9d68a38012cccd7ab2a2f861af9/urlobject-3.0.0.tar.gz
...
%prep
%setup -q -n urlobject-3.0.0
cd %{_builddir}/urlobject-3.0.0
pushd ..
cp -a urlobject-3.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752503221
